...
SELECT
    ...
    topup_count,
   ROUND((topup_count * 100.0 / total_growth_count), 2)AS top_up_percentage,
   ROUND(((total_growth_count - topup_count) * 100.0 / total_growth_count), 2) AS new_loan_percentage
FROM region_summary;
